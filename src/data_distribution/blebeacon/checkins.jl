...
minmonday = Dates.DateTime("2016-09-14T00:00:00")
mintime = minmonday
...
nintervals = ceil(Int,(maximum(df[!, :UTCtime]) - mintime)/Δₘ)
...
ax.set_xlim(0, length(distancewithinintervals))
...
xlabels = ["7\nMay", "", "", "12h", "", "", "8\nMay", "", "", "12h", "", "", "9\nMay", "", "", "", "", "", "10\nMay", "", "", "", "", "", "11\nMay", "", "", "", "", "", "12\nMay", "", "", "", "", "", "13\nMay", "", "", "", "", ""]
xlabels = collect(1:length(distancewithinintervals))

xticks(1:length(distancewithinintervals), xlabels, rotation=80)

gcf()

plt.tight_layout(.5)

savefig("src/data_distribution/blebeacon/plots/checkin_distribution.png")
