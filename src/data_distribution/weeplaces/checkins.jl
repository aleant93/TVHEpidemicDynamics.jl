...
dataset = "weeplaces/weeplace_checkins.csv"
header = [:userid, :placeid, :UTCtime, :lat, :lng, :city, :category]
dateformat = "yyyy-mm-ddTHH:MM:SS" #y-m-dTH:M:SZ

pth = joinpath(dirname(pathof(TVHEpidemicDynamics)),"..","data", dataset)
...
#2010-08-02T00:00:00 => 2010-08-09T00:00:00
# 2010-07-29T00:00:00 => 2010-08-28T00:00:00 MONTH
