...
output_path = joinpath(project_path, "experiments", "spreading", "AAMAS20", "results", "53")
...
# fparams =
#     joinpath(project_path, "experiments", "spreading", "AAMAS20", "configs", "54", "aamas54.csv")
# output_path = joinpath(project_path, "experiments", "spreading", "AAMAS20", "results", "54")
...
# the initial infected nodes have to be the same
