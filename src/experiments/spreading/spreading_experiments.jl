...
# WEEPLACES
output_path = joinpath(project_path, "experiments", "spreading", "weeplaces", "results")

fparams =
    joinpath(project_path, "experiments", "spreading", "weeplaces", "configs", "aamas53.json")

fdata_params =
    joinpath(project_path, "experiments", "spreading", "weeplaces", "configs", "weeplaces.json")
